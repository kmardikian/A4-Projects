...
public class PtktByPkrTblRow {
    ...
    final private SimpleIntegerProperty pak;
...
//        this.asg = new SimpleIntegerProperty(wAsg);
    ...
    ,int wPak,int wCpu, int wWgh, int wShp, int wInv,
    BigDecimal wPrtU, BigDecimal wPrtD, BigDecimal wDisU, 
    BigDecimal wDisD, BigDecimal wCusU, BigDecimal wCusD,
    BigDecimal wPckU, BigDecimal wPckD, BigDecimal wPakU, BigDecimal wPakD,
    ...
    Integer wPrtCtn, Integer wDisCtn, Integer wCusCtn, Integer wPckCtn, 
    Integer wPakCtn, Integer wCpuCtn, Integer wWghCtn, Integer wShpCtn, Integer wInvCtn ) {
        
        int wTot = wPrt + wDis+ wCus + wPck+ wPak + wCpu + wWgh + wShp + wInv; 
        this.prtCtn = wPrtCtn;
        this.disCtn = wDisCtn;
        this.cusCtn = wCusCtn;
        this.pckCtn = wPckCtn;
